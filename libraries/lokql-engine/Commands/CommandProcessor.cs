...
public class CommandProcessor : ICommandProcessor
{
    ...
    public static CommandProcessor Default()
    {
        var cp = (CommandProcessor)new CommandProcessor()
                ...
                .WithAdditionalCommand<ArgCommand.Options>(ArgCommand.RunAsync)
                .WithAdditionalCommand<LogAnalyticsCommand.Options>(LogAnalyticsCommand.RunAsync)
                .WithAdditionalCommand<DefenderCommand.Options>(DefenderCommand.RunAsync)
