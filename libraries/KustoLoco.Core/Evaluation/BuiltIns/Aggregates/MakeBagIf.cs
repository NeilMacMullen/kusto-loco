...
internal class MakeBagIfFunctionImpl : IAggregateImpl
{
    public EvaluationResult Invoke(ITableChunk chunk, ColumnarResult[] arguments)
    {
        ...
        var predicateColumn = (GenericTypedBaseColumnOfbool)arguments[1].Column;
        MyDebug.Assert(valuesColumn.RowCount == predicateColumn.RowCount);
        ...
        {
            var predicate = predicateColumn[i];
            ...
            // make_bag_if only processes property bags (JsonObject), skips other types
