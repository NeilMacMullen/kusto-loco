...
{
    public IRUserFunctionCallNode(Signature signature, IReadOnlyList<Parameter> parameters,
        IReadOnlyList<VariableSymbol> paramSymbols, IRFunctionBodyNode expandedBody,
        IRListNode<IRExpressionNode> arguments, TypeSymbol resultType)
    ...
    public override string ToString() =>
        $"UserFunctionCall({SchemaDisplay.GetText(Signature.Symbol)}): {SchemaDisplay.GetText(ResultType)}";
}