...
{
    public IROrderedExpressionNode(IRExpressionNode expression, SortDirections sortDirection,
        NullsDirections nullsDirection, TypeSymbol resultType)
    ...
    {
        return
            $"OrderedExpression {FormatDirection(SortDirection)} nulls {FormatNullsDirection(NullsDirection)}: {SchemaDisplay.GetText(ResultType)}";
