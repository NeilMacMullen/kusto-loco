...
{
    internal class GreaterThanOrEqualIntOperatorImpl : IScalarFunctionImpl
    {
    ...
    internal class GreaterThanOrEqualLongOperatorImpl : IScalarFunctionImpl
    {
        public ScalarResult InvokeScalar(ScalarResult[] arguments)
        {
            Debug.Assert(arguments.Length == 2);
    ...
    internal class GreaterThanOrEqualDoubleOperatorImpl : IScalarFunctionImpl
    {
        public ScalarResult InvokeScalar(ScalarResult[] arguments)
        {
            Debug.Assert(arguments.Length == 2);
