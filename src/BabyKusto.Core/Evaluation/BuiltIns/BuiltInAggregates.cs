...
internal static class BuiltInAggregates
{
    ...
    static BuiltInAggregates()
    {
        ...
        aggregates.Add(
            Aggregates.DCountIf,
            new AggregateInfo(
                new AggregateOverloadInfo(new DCountIfAggregateIntImpl(), ScalarTypes.Long, ScalarTypes.Int,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new DCountIfAggregateLongImpl(), ScalarTypes.Long, ScalarTypes.Long,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new DCountIfAggregateDoubleImpl(), ScalarTypes.Long, ScalarTypes.Real,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new DCountIfAggregateDateTimeImpl(), ScalarTypes.Long, ScalarTypes.DateTime,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new DCountIfAggregateTimeSpanImpl(), ScalarTypes.Long, ScalarTypes.TimeSpan,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new DCountIfAggregateStringImpl(), ScalarTypes.Long, ScalarTypes.String,
                    ScalarTypes.Bool)));

        aggregates.Add(
            Aggregates.SumIf,
            new AggregateInfo(
                new AggregateOverloadInfo(new SumIfIntFunctionImpl(), ScalarTypes.Int, ScalarTypes.Int,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new SumIfLongFunctionImpl(), ScalarTypes.Long, ScalarTypes.Long,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new SumIfDoubleFunctionImpl(), ScalarTypes.Real, ScalarTypes.Real,
                    ScalarTypes.Bool)));
        ...
        aggregates.Add(
            ...
            new AggregateInfo(
                new AggregateOverloadInfo(new PercentileAggregateIntImpl(), ScalarTypes.Long, ScalarTypes.Int,
                    ScalarTypes.Real),
                new AggregateOverloadInfo(new PercentileAggregateLongImpl(), ScalarTypes.Long, ScalarTypes.Long,
                    ScalarTypes.Real),
                new AggregateOverloadInfo(new PercentileAggregateDoubleImpl(), ScalarTypes.Real, ScalarTypes.Real,
                    ScalarTypes.Real)));
        ...
        aggregates.Add(
            ...
            new AggregateInfo(
                new AggregateOverloadInfo(new MakeSetIfIntFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Int,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeSetIfIntFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Int,
                    ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeSetIfLongFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Long,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeSetIfLongFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Long,
                    ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeSetIfDoubleFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Real,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeSetIfDoubleFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Real,
                    ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeSetIfTimeSpanFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.TimeSpan, ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeSetIfTimeSpanFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.TimeSpan, ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeSetIfDateTimeFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.DateTime, ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeSetIfDateTimeFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.DateTime, ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeSetIfStringFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.String,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeSetIfStringFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.String,
                    ScalarTypes.Bool, ScalarTypes.Long)));
        ...
        aggregates.Add(
            ...
            new AggregateInfo(
                ...
                new AggregateOverloadInfo(new MakeListDoubleFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Real,
                    ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeListTimeSpanFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.TimeSpan),
                new AggregateOverloadInfo(new MakeListTimeSpanFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.TimeSpan,
                    ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeListDateTimeFunctionImpl(), ScalarTypes.Dynamic,
        ...
        aggregates.Add(
            ...
            new AggregateInfo(
                new AggregateOverloadInfo(new MakeListIfIntFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Int,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeListIfIntFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Int,
                    ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeListIfLongFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Long,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeListIfLongFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Long,
                    ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeListIfDoubleFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Real,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeListIfDoubleFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.Real,
                    ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeListIfTimeSpanFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.TimeSpan, ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeListIfTimeSpanFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.TimeSpan, ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeListIfDateTimeFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.DateTime, ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeListIfDateTimeFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.DateTime, ScalarTypes.Bool, ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeListIfStringFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.String,
                    ScalarTypes.Bool),
                new AggregateOverloadInfo(new MakeListIfStringFunctionImpl(), ScalarTypes.Dynamic, ScalarTypes.String,
                    ScalarTypes.Bool, ScalarTypes.Long)));
        ...
        aggregates.Add(
            ...
            new AggregateInfo(
                ...
                new AggregateOverloadInfo(new MakeListWithNullsLongFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.Long),
                new AggregateOverloadInfo(new MakeListWithNullsDoubleFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.Real),
                new AggregateOverloadInfo(new MakeListWithNullsTimeSpanFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.TimeSpan),
                new AggregateOverloadInfo(new MakeListWithNullsDateTimeFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.DateTime),
                new AggregateOverloadInfo(new MakeListWithNullsStringFunctionImpl(), ScalarTypes.Dynamic,
                    ScalarTypes.String)));
    }
