...
internal class ToStringFromIntFunctionImpl : IScalarFunctionImpl
{
    ...
    private static string? Impl(int? input) => input.HasValue ? input.Value.ToString() : string.Empty;
}
...
internal class ToStringFromLongFunctionImpl : IScalarFunctionImpl
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static string? Impl(long? input) => input.HasValue ? input.Value.ToString() : string.Empty;
}
...
internal class ToStringFromRealFunctionImpl : IScalarFunctionImpl
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static string? Impl(double? input) => input.HasValue ? input.Value.ToString() : string.Empty;
}
...
internal class ToStringFromTimeSpanFunctionImpl : IScalarFunctionImpl
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static string? Impl(TimeSpan? input) => input.HasValue ? input.Value.ToString() : string.Empty;
}
...
internal class ToStringFromDateTimeFunctionImpl : IScalarFunctionImpl
{
    ...
    private static string? Impl(DateTime? input) =>
        input == null ? string.Empty : input.Value.ToString("M/d/yyyy h:mm:ss tt");
}
