    ...
    static BuiltInOperators()
    {
        operators.Add(
            ...
            new ScalarFunctionInfo(
                ...
                new ScalarOverloadInfo(new UnaryMinusTimeSpanOperatorImpl(), ScalarTypes.TimeSpan,
        ...
        operators.Add(
            ...
            new ScalarFunctionInfo(
                ...
                new ScalarOverloadInfo(new AddDoubleOperatorImpl(), ScalarTypes.Real, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new AddTimeSpanOperatorImpl(), ScalarTypes.TimeSpan, ScalarTypes.TimeSpan,
                    ScalarTypes.TimeSpan),
                new ScalarOverloadInfo(new AddDateTimeTimeSpanOperatorImpl(), ScalarTypes.DateTime,
                    ScalarTypes.DateTime, ScalarTypes.TimeSpan)));

        operators.Add(
            Operators.Subtract,
            new ScalarFunctionInfo(
                new ScalarOverloadInfo(new SubtractIntOperatorImpl(), ScalarTypes.Int, ScalarTypes.Int,
                    ScalarTypes.Int),
                new ScalarOverloadInfo(new SubtractLongOperatorImpl(), ScalarTypes.Long, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new SubtractDoubleOperatorImpl(), ScalarTypes.Real, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new SubtractTimeSpanOperatorImpl(), ScalarTypes.TimeSpan, ScalarTypes.TimeSpan,
                    ScalarTypes.TimeSpan),
                new ScalarOverloadInfo(new SubtractDateTimeTimeSpanOperatorImpl(), ScalarTypes.DateTime,
                    ScalarTypes.DateTime, ScalarTypes.TimeSpan),
        ...
        operators.Add(
            Operators.Multiply,
            new ScalarFunctionInfo(
                new ScalarOverloadInfo(new MultiplyIntOperatorImpl(), ScalarTypes.Int, ScalarTypes.Int,
                    ScalarTypes.Int),
                new ScalarOverloadInfo(new MultiplyLongOperatorImpl(), ScalarTypes.Long, ScalarTypes.Long,
                    ScalarTypes.Long),
        ...
        operators.Add(
            ...
            new ScalarFunctionInfo(
                ...
                new ScalarOverloadInfo(new DivideLongOperatorImpl(), ScalarTypes.Long, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new DivideDoubleOperatorImpl(), ScalarTypes.Real, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new DivideTimeSpanOperatorImpl(), ScalarTypes.Real, ScalarTypes.TimeSpan,
                    ScalarTypes.TimeSpan)));
        ...
        operators.Add(
            ...
            new ScalarFunctionInfo(
                ...
                new ScalarOverloadInfo(new ModuloLongOperatorImpl(), ScalarTypes.Long, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new ModuloDoubleOperatorImpl(), ScalarTypes.Real, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new ModuloDateTimeTimeSpanOperatorImpl(), ScalarTypes.TimeSpan,
                    ScalarTypes.DateTime, ScalarTypes.TimeSpan)));

        operators.Add(
            Operators.GreaterThan,
            new ScalarFunctionInfo(
                new ScalarOverloadInfo(new GreaterThanIntOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Int,
                    ScalarTypes.Int),
                new ScalarOverloadInfo(new GreaterThanLongOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new GreaterThanDoubleOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new GreaterThanTimeSpanOperatorImpl(), ScalarTypes.Bool, ScalarTypes.TimeSpan,
                    ScalarTypes.TimeSpan),
                new ScalarOverloadInfo(new GreaterThanDateTimeOperatorImpl(), ScalarTypes.Bool, ScalarTypes.DateTime,
                    ScalarTypes.DateTime)));

        operators.Add(
            Operators.GreaterThanOrEqual,
            new ScalarFunctionInfo(
                new ScalarOverloadInfo(new GreaterThanOrEqualIntOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Int,
                    ScalarTypes.Int),
                new ScalarOverloadInfo(new GreaterThanOrEqualLongOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new GreaterThanOrEqualDoubleOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new GreaterThanOrEqualTimeSpanOperatorImpl(), ScalarTypes.Bool,
                    ScalarTypes.TimeSpan, ScalarTypes.TimeSpan),
                new ScalarOverloadInfo(new GreaterThanOrEqualDateTimeOperatorImpl(), ScalarTypes.Bool,
                    ScalarTypes.DateTime, ScalarTypes.DateTime)));

        operators.Add(
            Operators.LessThan,
            new ScalarFunctionInfo(
                new ScalarOverloadInfo(new LessThanIntOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Int,
                    ScalarTypes.Int),
                new ScalarOverloadInfo(new LessThanLongOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new LessThanDoubleOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new LessThanTimeSpanOperatorImpl(), ScalarTypes.Bool, ScalarTypes.TimeSpan,
                    ScalarTypes.TimeSpan),
                new ScalarOverloadInfo(new LessThanDateTimeOperatorImpl(), ScalarTypes.Bool, ScalarTypes.DateTime,
                    ScalarTypes.DateTime)));

        operators.Add(
            Operators.LessThanOrEqual,
            new ScalarFunctionInfo(
                new ScalarOverloadInfo(new LessThanOrEqualIntOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Int,
                    ScalarTypes.Int),
                new ScalarOverloadInfo(new LessThanOrEqualLongOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new LessThanOrEqualDoubleOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new LessThanOrEqualTimeSpanOperatorImpl(), ScalarTypes.Bool,
                    ScalarTypes.TimeSpan, ScalarTypes.TimeSpan),
                new ScalarOverloadInfo(new LessThanOrEqualDateTimeOperatorImpl(), ScalarTypes.Bool,
                    ScalarTypes.DateTime, ScalarTypes.DateTime)));
        ...
        operators.Add(
            ...
            new ScalarFunctionInfo(
                ...
                new ScalarOverloadInfo(new EqualLongOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new EqualDoubleOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new EqualStringOperatorImpl(), ScalarTypes.Bool, ScalarTypes.String,
                    ScalarTypes.String),
                new ScalarOverloadInfo(new EqualTimeSpanOperatorImpl(), ScalarTypes.Bool, ScalarTypes.TimeSpan,
                    ScalarTypes.TimeSpan),
                new ScalarOverloadInfo(new EqualDateTimeOperatorImpl(), ScalarTypes.Bool, ScalarTypes.DateTime,
                    ScalarTypes.DateTime)));

        operators.Add(
            Operators.NotEqual,
            new ScalarFunctionInfo(
                new ScalarOverloadInfo(new NotEqualIntOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Int,
                    ScalarTypes.Int),
                new ScalarOverloadInfo(new NotEqualLongOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Long,
                    ScalarTypes.Long),
                new ScalarOverloadInfo(new NotEqualDoubleOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Real,
                    ScalarTypes.Real),
                new ScalarOverloadInfo(new NotEqualStringOperatorImpl(), ScalarTypes.Bool, ScalarTypes.String,
                    ScalarTypes.String),
                new ScalarOverloadInfo(new NotEqualTimeSpanOperatorImpl(), ScalarTypes.Bool, ScalarTypes.TimeSpan,
                    ScalarTypes.TimeSpan),
                new ScalarOverloadInfo(new NotEqualDateTimeOperatorImpl(), ScalarTypes.Bool, ScalarTypes.DateTime,
                    ScalarTypes.DateTime)));

        operators.Add(
            Operators.And,
            new ScalarFunctionInfo(
                new ScalarOverloadInfo(new LogicalAndOperatorImpl(), ScalarTypes.Bool, ScalarTypes.Bool,
                    ScalarTypes.Bool)));
