...
public abstract class DigestTest
{
    ...
    protected DigestTest(ITestOutputHelper testOutputHelper) => this.testOutputHelper = testOutputHelper;
    ...
    public void TestFewValues()
    {
        ...
        foreach (var q in new[] { 0, 1e-10, rng.NextDouble(), 0.5, 1 - 1e-10, 1 })
        {
    ...
    public void TestMoreThan2BValues()
    {
        ...
        var quantiles = new[] { 0, 0.1, 0.5, 0.9, 1, rng.NextDouble() };
