...
public class KustoQueryV2ResponseWriterTests
{
    ...
    public async Task OneTable_Works()
    {
        ...
        result.Should()
            .Be(
                "[{'FrameType':'DataSetHeader','IsProgressive':false,'Version':'v2.0'},{'FrameType':'DataTable','TableId':0,'TableKind':'PrimaryResult','TableName':'PrimaryResult','Columns':[{'ColumnName':'MyColumn','ColumnType':'string'}],'Rows':[['a']]},{'FrameType':'DataSetCompletion','HasErrors':false,'Cancelled':false}]"
                    .Replace("\'", "\""));
    }
}