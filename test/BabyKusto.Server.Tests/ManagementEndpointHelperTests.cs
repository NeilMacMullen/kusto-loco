...
public class ManagementEndpointHelperTests
{
    ...
    public void ShowVersion_Works()
    {
        ...
        columns.Should()
            .Be(
                "BuildVersion:String:string,BuildTime:DateTime:datetime,ServiceType:String:string,ProductVersion:String:string,ServiceOffering:String:string");
        ...
        values.Should()
            .Be(
                "\"0.0.0\",\"2022-10-07T23:00:00Z\",\"Engine\",\"0.0.0\",\"{\\u0022Type\\u0022:\\u0022Azure Data Explorer\\u0022}\"");
    }
    ...
    public void ShowDatabases_Works()
    {
        ...
        columns.Should()
            .Be(
                "DatabaseName:String:string,PersistentStorage:String:string,Version:String:string,IsCurrent:Boolean:bool,DatabaseAccessMode:String:string,PrettyName:String:string,ReservedSlot1:Boolean:bool,DatabaseId:Guid:guid,InTransitionTo:String:string");
        ...
        values.Should()
            .Be(
                "\"BabyKusto\",\"\",\"v1.0\",false,\"ReadWrite\",null,null,\"fe60d09c-de8e-4832-9bd3-ee3f5a723a26\",\"\"");
    }
    ...
    private class ConstTablesProvider : ITablesProvider
    {
        ...
        public List<ITableSource> GetTables() => _tables.ToList();
    }
}